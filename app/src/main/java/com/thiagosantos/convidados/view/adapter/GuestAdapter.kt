package com.thiagosantos.convidados.view.adapter
...
import com.thiagosantos.convidados.view.viewholder.GuestViewHolder
...
class GuestAdapter : RecyclerView.Adapter<GuestViewHolder>() {
    ...
    fun attachListeners(listener: GuestListener){
        mListener = listener
    }
}